...
unset($__errorArgs, $__bag); ?> bg-dark text-white" id="namaProduk" name="namaProduk" value="<?php echo e(old('namaProduk')); ?>" placeholder="Enter product name">
...
unset($__errorArgs, $__bag); ?> bg-dark text-white" id="harga" name="harga" value="<?php echo e(old('harga')); ?>" aria-label="Amount (without decimal)" step="100">
...
unset($__errorArgs, $__bag); ?> bg-dark text-white" id="deskripsi" name="deskripsi" rows="3" placeholder="Enter product description"><?php echo e(old('deskripsi')); ?></textarea>
...
unset($__errorArgs, $__bag); ?> bg-dark text-white" id="satuanID" name="satuanID" value="<?php echo e(old('satuanID')); ?>" placeholder="Enter Satuan ID">
